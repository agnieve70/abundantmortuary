...
export const planholder_list = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(BASE_URL + "/get-planholder", config);
...
export const beneficiary_list = (planholder_id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      BASE_URL + "/get-beneficiaries/" + planholder_id,
      config
    );
...
export const get_single_data = (planholder_id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      BASE_URL + "/get-single-data/" + planholder_id,
      config
    );
...
export const update_personal_info =
  (personalInfo, planholder_id) => async (dispatch) => {
    try {
      dispatch({
      ...
      const { data } = await axios.put(
        BASE_URL + "/update-planholder/" + planholder_id,
        personalInfo,
        config
      );
...
export const add_data = (dataInfo) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(BASE_URL + "/add-data", dataInfo, config);
...
export const update_beneficiary =
  (beneficiaryInfo, beneficiary_id) => async (dispatch) => {
    try {
      dispatch({
      ...
      const { data } = await axios.put(
        BASE_URL + "/update-beneficiary/" + beneficiary_id,
        beneficiaryInfo,
        config
      );
